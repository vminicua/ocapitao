...
MODEL_ENDPOINTS = {
    ...
    "customers.LoyaltyProgram": "loyalty-programs",
    "customers.Promotion": "promotions",
    "customers.PromotionRedemption": "promotion-redemptions",
    ...
    "inventory.StockLocation": "stock-locations",
    "inventory.StockBalance": "stock-balances",
    "inventory.PurchaseOrder": "purchase-orders",
    "inventory.PurchaseOrderItem": "purchase-order-items",
    "inventory.StockLot": "stock-lots",
    "inventory.StockCount": "stock-counts",
    "inventory.StockCountLine": "stock-count-lines",
    "inventory.StockTransfer": "stock-transfers",
...
API_RELATION_FIELDS = {
    ...
    "customers.Promotion": {"eligible_services": "eligible_service_ids"},
